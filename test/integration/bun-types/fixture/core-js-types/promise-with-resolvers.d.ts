// Vendored from https://github.com/zloirock/core-js/blob/v4-types/packages/core-js-types/src/base/proposals/promise-with-resolvers.d.ts
// License: https://github.com/nicolo-ribaudo/core-js/blob/types-package/LICENSE.md
...
interface PromiseWithResolvers<T> {
  // @type-options: no-extends, no-prefix
